...
<div class="copyright-text footer-bottom">
    <div class="container">
        <div class="row align-items-center">
            <p class="col-lg-8 col-sm-12 footer-text m-0 text-center text-lg-left"><?php echo wp_kses_post( umeetevent_opt( 'umeetevent-copyright-text-settings', $copyText ) ); ?></p>
            <?php
            if( has_nav_menu( 'social-menu' ) ) {
                echo '<div class="col-lg-4 col-sm-12 footer-social text-center text-lg-right">';
                    $args = array(
                        ...
                        'fallback_cb'    => 'umeetevent_social_navwalker::fallback',
                        'walker'         => new umeetevent_social_navwalker(),
                    );  
                    wp_nav_menu( $args );
                echo '</div>';
            }
