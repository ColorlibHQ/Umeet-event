...
class umeetevent_author_widget extends WP_Widget {
...
'umeetevent_author_widget',


// Widget name will appear in UI
esc_html__( '[ UmeetEvent ] Author Widget', 'umeetevent' ),

// Widget description
array( 'description' => esc_html__( 'Add author content', 'umeetevent' ), )
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Author Name', 'umeetevent' );
}
...
?>
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:' ,'umeetevent'); ?></label>
<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
</p>

<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'designation' ) ); ?>"><?php esc_html_e( 'Designation:' ,'umeetevent'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'textarea' ) ); ?>"><?php esc_html_e( 'Short Descriptions:' ,'umeetevent'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Facebook Url' ) ); ?>"><?php esc_html_e( 'Facebook Url:' ,'umeetevent'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Twitter Url' ) ); ?>"><?php esc_html_e( 'Twitter Url:' ,'umeetevent'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Dribbble Url' ) ); ?>"><?php esc_html_e( 'Dribbble Url:' ,'umeetevent'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Behance Url' ) ); ?>"><?php esc_html_e( 'Behance Url:' ,'umeetevent'); ?></label>
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>"><?php _e( 'Image', 'umeetevent' ); ?>:</label>
	<div class="umeetevent-media-container">
		<div class="umeetevent-media-inner">
			...
			<span class="umeetevent-no-image" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-noimg" <?php echo wp_kses_post( $no_img_style ); ?>><?php _e( 'No image selected', 'umeetevent' ); ?></span>
		</div>
	
	<input type="text" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'image' ) ); ?>" value="<?php echo esc_attr( $image ); ?>" class="umeetevent-media-url" />

	<input type="button" value="<?php echo _e( 'Remove', 'umeetevent' ); ?>" class="button umeetevent-media-remove" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-remove" <?php echo wp_kses_post( $img_style ); ?> />

	<?php $button_text = ( $image != '' ) ? __( 'Change Image', 'umeetevent' ) : __( 'Select Image', 'umeetevent' ); ?>
	<input type="button" value="<?php echo esc_html( $button_text ); ?>" class="button umeetevent-media-upload" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-button" />
	<br class="clear">
	</div>
</p>
<style>
.umeetevent-media-container {
	width: 98%;
}

.umeetevent-media-inner {
...
.umeetevent-media-inner img {
	max-width: 100%;
	height: auto;
}

.umeetevent-media-url {
	display: none;
}

.umeetevent-media-remove {
	float: left;
	width: 48%;
}

.umeetevent-media-upload {
	float: right;
	width: 48%;
}
</style>
...
jQuery(function($){
    ...
    wpshed_image_upload( '.umeetevent-media-upload' );
    ...
    wpshed_image_remove( '.umeetevent-media-remove' );
...
} // Class umeetevent_author_widget ends here


// Register and load the widget
function umeetevent_author_load_widget() {
	register_widget( 'umeetevent_author_widget' );
}
add_action( 'widgets_init', 'umeetevent_author_load_widget' );