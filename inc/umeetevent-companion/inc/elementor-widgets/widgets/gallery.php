 ...
 * @since 1.0
 */
class UmeetEvent_Gallery extends Widget_Base {

	public function get_name() {
		return 'umeetevent-gallery';
	}

	public function get_title() {
		return __( 'Gallery', 'umeetevent' );
	}
	...
	protected function _register_controls() {
        ...
        // Start Section Title=====================================
         $this->start_controls_section(
            'gallery_heading', [
                'label' => esc_html__( 'Gallery Section Heading', 'umeetevent' ),
            ]
        );
        $this->add_control(
            'sect_title', [
		...
		$this->start_controls_section(
			'gallery_block',
			[
				'label' => __( 'Gallery', 'umeetevent' ),
			]
		);
		$this->add_control(
            'gallery', [
                'label'     => __( 'Gallery Images', 'umeetevent' ),
                    ...
                    foreach( $settings['gallery'] as $image ): ?>
                        <div class="col-sm-6 col-md-4">
                            <a href="<?php echo esc_url( $image['url'] ) ?>" class="img-gal">
                                ...
                                <?php echo '<img class="card-img rounded-0" src="'. $image['url'] .'" alt="'. esc_html__( 'gallery image', 'umeetevent' ) .'">'; ?>
                                <div class="overlay">
