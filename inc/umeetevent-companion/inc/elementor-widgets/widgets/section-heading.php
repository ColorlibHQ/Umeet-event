 ...
 * @since 1.0
 */
class UmeetEvent_sh extends Widget_Base {

	public function get_name() {
		return 'umeetevent-sh';
	}

	public function get_title() {
		return __( 'Section Heading', 'umeetevent' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'sh_content',
            [
                'label' => __( 'Section Heading', 'umeetevent' ),
            ]
        );
        $this->add_control(
            'sh_sectiontitle',
        ...
        $this->add_control(
            'sh_sectionsubtitle',
            [
                'label'       => esc_html__( 'Sub Title', 'umeetevent' ),
                'label_block' => true,
                'type'        => Controls_Manager::TEXT,
            ]
        );
        ...
        $this->start_controls_section(
            'style_section', [
                'label' => __( 'Style Section', 'umeetevent' ),
