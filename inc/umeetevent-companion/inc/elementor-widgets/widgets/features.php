 ...
 * @since 1.0
 */
class UmeetEvent_Features extends Widget_Base {

	public function get_name() {
		return 'umeetevent-features';
	}

	public function get_title() {
		return __( 'Features', 'umeetevent' );
	}
	...
	protected function _register_controls() {
            ...
            'features_content', [
                ...
                'fields' => [
                    [
                        ...
                        'type'  => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default' => __('Learn Online Courses', 'umeetevent')
                    ],
	                [
		                'name'  => 'desc',
                    ...
                    [
                        'name'  => 'icon',
                        'label' => __( 'Feature Icon', 'umeetevent' ),
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'icon_bg',
                'label' => __( 'Feature Icon Background Image', 'umeetevent' ),
                'types' => [ 'classic' ],
        ...
        $this->add_control(
            'btn_one_label', [
                'label' => esc_html__( 'Button One Label', 'umeetevent' ),
                'type'  => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__('Learn More', 'umeetevent')

            ]
        );
        $this->add_control(
            'btn_one_url', [
                'label' => esc_html__( 'Button One URL', 'umeetevent' ),
        ...
        $this->add_control(
            'btn_two_label', [
                'label' => esc_html__( 'Button Two Label', 'umeetevent' ),
                'type'  => Controls_Manager::TEXT,
                'label_block' => true,
        ...
        $this->add_control(
            'btn_two_url', [
                'label' => esc_html__( 'Button Two URL', 'umeetevent' ),
                'type'  => Controls_Manager::URL,
                'label_block' => true
        ...
        $this->start_controls_section(
            'style_section_heading', [
                'label' => __( 'Style Section Title', 'umeetevent' ),
        ...
        $this->start_controls_section(
            'style_features', [
                'label' => __( 'Style Features', 'umeetevent' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Feature Title ', 'umeetevent' ),
        ...
        $this->add_control(
            'feature_hover_title', [
                'label' => __( 'Feature Hover Title Color', 'umeetevent' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'feature_desc_color', [
                'label' => __( 'Feature Description Color', 'umeetevent' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#797979',
                'selectors' => [
        ...
        $this->add_control(
            'feature_button',
            [
                'label'     => __( 'Feature Button Style ', 'umeetevent' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'feature_btn1_label_color', [
                'label' => __( 'Button One Label Color', 'umeetevent' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#242424',
                'selectors' => [
        ...
        $this->add_control(
            'feature_btn1_hover_label_color', [
                'label' => __( 'Button One Hover Label Color', 'umeetevent' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'feature_btn1_border_color', [
                'label' => __( 'Button One Border Color', 'umeetevent' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#3b1d82',
                'selectors' => [
        ...
        $this->add_control(
            'feature_btn1_hover_border_color', [
                'label' => __( 'Button One Hover Border Color', 'umeetevent' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#3b1d82',
                'selectors' => [
        ...
        $this->add_control(
            'feature_btn1_bg', [
                'label' => __( 'Button One Background', 'umeetevent' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'feature_btn1_hover_bg', [
                'label' => __( 'Button One Hover Background', 'umeetevent' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#3b1d82',
                'selectors' => [
        ...
        $this->add_control(
            'feature_button2',
            [
                'label'     => __( 'Feature Button Two Style ', 'umeetevent' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
