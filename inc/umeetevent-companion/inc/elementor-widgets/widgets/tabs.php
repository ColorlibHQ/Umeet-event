 ...
 * @since 1.0
 */
class Umeetevent_tabs extends Widget_Base {

	public function get_name() {
		return 'umeetevent-food-menu-tab';
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'schedule_heading', [
                'label' => esc_html__( 'Schedule Section Heading', 'umeetevent' ),
            ]
        );
        $this->add_control(
            'sect_title', [
        ...
        $this->start_controls_section(
            'menu_tab_sec',
            [
                'label' => __( 'Event Schedule', 'umeetevent' ),
            ]
        );
        ...
        $this->add_control(
            'schedules', [
                ...
                'fields' => [
                    ...
                    [
                        'name'        => 'time_duration',
                        'label'       => __( 'Time Duration', 'umeetevent' ),
                        'type'        => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default'     => esc_html__( '9.00 AM - 10.30 AM', 'umeetevent' )
                    ],
                    [
                        'name'        => 'title',
                        ...
                        'type'        => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default'     => esc_html__( 'Previous Year achivement', 'umeetevent' )
                    ],
                    [
                        'name'        => 'description',
                        ...
                        'type'        => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default'     => esc_html__( 'And wherein Beginning of you cattle fly had was deep wherein darkness behold male called evening gathering moving bring fifth days he lights dry cattle you open seas midst let and in wherein beginning', 'umeetevent' )
                    ],
                    [
                        'name'        => 'speaker',
                        'label'       => esc_html__( 'Speaker Image', 'umeetevent' ),
                        'type'        => Controls_Manager::MEDIA,
                        'label_block' => true,
                    ...
                    [
                        'name'        => 'speaker_name',
                        'label'       => esc_html__( 'Speaker Name', 'umeetevent' ),
                        'type'        => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default'     => esc_html__('Adam Jamsmith', 'umeetevent')
                    ...
                    [
                        ...
                        'type'        => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default'     => esc_html__( 'UX/UI Designer', 'umeetevent' )
        ...
        $this->start_controls_section(
            'style_tab', [
                'label' => __( 'Style Tab Nav', 'umeetevent' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'tab_item_color', [
                'label'     => __( 'Tab Item Color', 'umeetevent' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'tab_item_background', [
                'label'     => __( 'Tab Item Background Color', 'umeetevent' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'tab_item_active_color', [
                'label'     => __( 'Tab Item Active Color', 'umeetevent' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'tab_item_active_background', [
                'label'     => __( 'Tab Item Active Background Color', 'umeetevent' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'schedule_desc', [
                'label' => __( 'Style Tab Content', 'umeetevent' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'schedule_title', [
                'label'     => __( 'Schedule Title Color', 'umeetevent' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'speaker_bg', [
                'label'     => __( 'Speaker Background', 'umeetevent' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'speaker_hover_bg', [
                'label'     => __( 'Speaker Hover Background', 'umeetevent' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'descriptio_bg', [
                'label'     => __( 'Description Background', 'umeetevent' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
