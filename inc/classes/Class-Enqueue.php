...
class UmeetEvent_Enqueue {

	public $scripts = array();

	public function umeetevent_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'umeetevent_frontend_enqueue_scripts', ) );
	}

	public function umeetevent_frontend_enqueue_scripts( ) {
