...
// umeetevent comment template callback
function umeetevent_comment_callback( $comment, $args, $depth ) {
                ...
                <div class="user justify-content-between d-flex">
                    ...
                    <div class="desc">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <p class="date"><?php printf( __('%1$s at %2$s', 'umeetevent'), get_comment_date(),  get_comment_time() ); ?><?php edit_comment_link( esc_html__( '(Edit)', 'umeetevent' ), '  ', '' ); ?></p>
                            </div>
...
add_filter('comment_reply_link', 'umeetevent_replace_reply_link_class');
function umeetevent_replace_reply_link_class( $class ) {
